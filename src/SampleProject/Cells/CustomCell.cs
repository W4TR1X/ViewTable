...
public abstract class CustomCell : Cell//, ICustomHtmlCell, ICustomSheetCell
{
    ...
    protected CustomCell(string identifier = "") : base(values: new List<CellValue>(), style: null, identifier)
    {

    }

    public virtual void Render(ExcelRange selectedRange, Row row, Cell cell)
    {
